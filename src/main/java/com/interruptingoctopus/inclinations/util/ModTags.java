...
public class ModTags {
    public static class Blocks {
        ...
        private static TagKey<Block> createTag(String name) {
            return BlockTags.create(ResourceLocation.fromNamespaceAndPath(Inclinations.MOD_ID,name));
        }
    }

    public static class Items {
        //public static final TagKey<Item> X_Y_Z = createTag("x_y_Z");

        private static TagKey<Item> createTag(String name){
            return ItemTags.create(ResourceLocation.fromNamespaceAndPath(Inclinations.MOD_ID,name));
        }
    }
}
